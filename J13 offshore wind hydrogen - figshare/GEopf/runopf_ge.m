...
%% contraints
Pptg = Qptg/24/3600 * GCV.ng * eta.electrolysis / baseMVA;
boxCons = [
...
objfcn = objfcn_IEGSoperatingCost(Pg,PGs,mpc) + 0* (Prs_square - 55^2); % closer to mid level
