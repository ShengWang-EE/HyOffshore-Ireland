function [HGEsolution, HGEinfo] = runopf_hge_drcc(mpc,mu,sigma,epsilon,hymax)
% this function is to run the DRCC based optimal energy flow for
% hydrogen-blended electricity and gas systems
%
...
[   sol{v}.totalCost,   sol{v}.genAndLCeCost,   sol{v}.gasPurchasingCost,   sol{v}.gasCurtailmentCost, ...
    sol{v}.PTGsubsidy,  sol{v}.objfcn,          sol{v}.Prs,...
...
deal(...
    ...
    PTGsubsidy,         objfcn,                 Prs,...
    PGs,                Qd,                     Qptg,                       Pptg,...
    Pg * baseMVA,       Pgpp * baseMVA,         Qgpp,                       Va,...
